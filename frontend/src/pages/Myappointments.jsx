...
const Myappointments = () => {
  ...
  return (
    <div>
      <p className='pb-3 mt-12 font-medium text-zinc-700 border-zinc-200 border-b'>My appointments</p>
      <div>
        {doctors.slice(0,3).map((item,index)=>(
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-zinc-200 border-b' key={index}>
            <div>
